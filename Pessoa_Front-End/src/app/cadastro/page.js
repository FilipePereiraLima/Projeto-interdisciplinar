    ...
    <main>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" class="flex items-center">
            <Image
              width={300}
              height={300}
              src="https://image.icons8.com/?size=512&id=sXHXa8UD0TX4&format=png"
              class="h-8 mr-3"
              alt="Geekstore Logo"
            />
      ...
      <div className={'flex flex-col justify-center items-center mt-40'}>
        <div className={'bg-[#111827] px-4 py-6 rounded-2xl'}>
          <h1 className="text-white flex flex-col justify-center items-center text-3xl font-bold mb-4 ">
            Cadastrar Produto
          </h1>
          ...
          <form onSubmit={cadastrar}>
            ...
            <br />
            <button
              className=" text-lg mt-2 border border-[#152848] p-4 rounded w-36 mx-2 hover:bg-blue-900 text-white font-bold bg-[#152848] "
              type="submit"
            >
              Cadastrar
            </button>

            <button className="text-lg mt-2 border border-[#152848] p-4 rounded w-36 mx-2 hover:bg-blue-900 text-white font-bold bg-[#152848]">
              <a href="/">Voltar</a>
            </button>
          </form>
        </div>
